...
| Part | Link Status | Main Page | Datasheet Path |
|------|-------------|-----------|----------------|
| **RL78G23** | ✅ | https://www.renesas.com/rl78g23 | `<cwd>/embedded_dev/renesas/datasheet/RL78G23_datasheet.pdf` |
| **RL78G14** | ✅ | https://www.renesas.com/rl78g14 | `<cwd>/embedded_dev/renesas/datasheet/RL78G14_datasheet.pdf` |
| **RL78H1D** | ✅ | https://www.renesas.com/rl78h1d | `<cwd>/embedded_dev/renesas/datasheet/RL78H1D_datasheet.pdf` |
| **RL78I1D** | ✅ | https://www.renesas.com/rl78i1d | `<cwd>/embedded_dev/renesas/datasheet/RL78I1D_datasheet.pdf` |
...
| Part | Link Status | Main Page | Datasheet Path |
|------|-------------|-----------|----------------|
| **RA4M1** | ✅ | https://www.renesas.com/ra/ra4m1 | `<cwd>/embedded_dev/renesas/datasheet/RA4M1_datasheet.pdf` |
